...
public class Pertanyaan10Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pertnyaan10);

        next = (Button) findViewById(R.id.btn_result);
    ...
    protected class BtnListener implements View.OnClickListener{
        ...
        public void onClick(View v) {
            ...
            benar = (RadioButton) findViewById(R.id.radio_button_pertama);
            ...
            if (radioGroup.getCheckedRadioButtonId() == -1)
            {
                ...
                AlertDialog alertDialog = new AlertDialog.Builder(
                        Pertanyaan10Activity.this).create();
            ...
            else
            {
                ...
                Intent next = new Intent(Pertanyaan10Activity.this, ResultActivity.class);
